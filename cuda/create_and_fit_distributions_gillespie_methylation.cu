...
// so for this version, we will attempt to simulate cpg methylation as it changes after replication.
// we can still fit all the parameters i think
// methylation rates 
...
// /home/data/nlaszik/cuda_simulation/code/cuda/build/create_and_fit_distributions_gillespie -mi 100000 -mt 10.0 -mc 400 -s 0.1 -h 2.0 -bs 1000000 -i /home/data/Shared/shared_datasets/sc-rna-seq/SRP299892/seurat/transcript_counts/srr13336770_transcript_counts.filtered.norm.csv -o /home/data/nlaszik/cuda_simulation/output/SRP299892 -mode full_model -ll -3.0 -ul 3.0

// DKO
// /home/data/nlaszik/cuda_simulation/code/cuda/build/create_and_fit_distributions_gillespie -mi 100000 -mt 10.0 -mc 150 -s 0.05 -h 1.0 -bs 1000000 -i /home/data/Shared/shared_datasets/sc_rna_seq/dko_atrinh_102022/seurat/transcript_counts/rep2_transcript_counts.filtered.norm.csv -o /home/data/nlaszik/cuda_simulation/output/dko_hesc/rep2 -mode no_np -ll -3.0 -ul 3.0
