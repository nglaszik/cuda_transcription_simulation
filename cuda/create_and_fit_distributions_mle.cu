...
void simulate(int max_iterations, double max_time, int num_cells, int num_genes, int i_batch, int batch_size, int num_combinations_current_batch, const int num_params, int max_count, double h, double *param_combinations, int *transcriptional_states, int *mrna_count, double *initial_distributions, double *real_distributions, double *best_likelihoods, int *best_params, int *best_counts, curandState* globalState){
	...
	for (int i_param_combination = index; i_param_combination < num_combinations_current_batch; i_param_combination+=stride) {
		...
		// so this isn't really a kde, but a holder of counts
		...
		for (int i_gene = 0; i_gene < num_genes; i_gene++) {
			...
			for (int i_count = 0; i_count < max_count; i_count++) {
				...
				log_likelihood += initial_distributions[i_simulated_count] * log(real_distributions[i_real_count]);
			}
...
// nvcc /home/data/nlaszik/cuda_simulation/code/cuda/create_and_fit_distributions_gillespie_mle.cu -o /home/data/nlaszik/cuda_simulation/code/cuda/build/create_and_fit_distributions_gillespie_mle -lcurand -lboost_filesystem -lboost_system -lineinfo

// SRP215251
// /home/data/nlaszik/cuda_simulation/code/cuda/build/create_and_fit_distributions_gillespie_mle -mi 100000 -mt 50.0 -mc 400 -s 1.0 -h 4.0 -bs 2000000 -i /home/data/Shared/shared_datasets/sc-rna-seq/SRP215251/figures/wt/tpm_filtered.csv -o /home/data/nlaszik/cuda_simulation/output/SRP215251/WT -mode no_np -ll -5.0 -ul 1.0

// /home/data/nlaszik/cuda_simulation/code/cuda/build/create_and_fit_distributions_gillespie_mle -mi 100000 -mt 50.0 -mc 400 -s 1.0 -h 4.0 -bs 2000000 -i /home/data/Shared/shared_datasets/sc-rna-seq/SRP215251/figures/dko/tpm_filtered.csv -o /home/data/nlaszik/cuda_simulation/output/SRP215251/DKO -mode no_np -ll -5.0 -ul 1.0

// SRP313343
// /home/data/nlaszik/cuda_simulation/code/cuda/build/create_and_fit_distributions_gillespie_mle -mi 100000 -mt 50.0 -mc 400 -s 1.0 -h 4.0 -bs 2000000 -i /home/data/Shared/shared_datasets/sc-rna-seq/SRP313343/seurat/transcript_counts/srr14139729_transcript_counts.filtered.norm.csv -o /home/data/nlaszik/cuda_simulation/output/SRP313343/SRR14139729 -mode no_np -ll -5.0 -ul 1.0

// SRP299892
// smaller batch size due to higher # of cells?
// /home/data/nlaszik/cuda_simulation/code/cuda/build/create_and_fit_distributions_gillespie_mle -mi 100000 -mt 50.0 -mc 400 -s 0.1 -h 4.0 -bs 1000000 -i /home/data/Shared/shared_datasets/sc-rna-seq/SRP299892/seurat/transcript_counts/srr13336770_transcript_counts.filtered.norm.csv -o /home/data/nlaszik/cuda_simulation/output/SRP299892_mle -mode no_np -ll -1.0 -ul 1.0

// DKO
// /home/data/nlaszik/cuda_simulation/code/cuda/build/create_and_fit_distributions_gillespie_mle -mi 100000 -mt 50.0 -mc 150 -s 0.02 -h 4.0 -bs 1000000 -i /home/data/Shared/shared_datasets/sc-rna-seq/dko_hesc/seurat/transcript_counts/rep2_transcript_counts.filtered.norm.csv -o /home/data/nlaszik/cuda_simulation/output/dko_hesc/rep2 -mode no_np -ll -5.0 -ul 1.0

// DKO same median
// /home/data/nlaszik/cuda_simulation/code/cuda/build/create_and_fit_distributions_gillespie_mle -mi 100000 -mt 50.0 -mc 150 -s 1.0 -h 4.0 -bs 1000000 -i /home/data/Shared/shared_datasets/sc-rna-seq/dko_hesc/seurat/set_median/rep1_transcript_counts.filtered.norm.csv -o /home/data/nlaszik/cuda_simulation/output/dko_hesc/rep1_gillespie_set_median/ -mode no_np -ll -5.0 -ul 1.0

// Andrew's data
// /home/data/nlaszik/cuda_simulation/code/cuda/build/create_and_fit_distributions_gillespie_mle -mi 100000 -mt 50.0 -mc 400 -s 1.0 -h 4.0 -bs 1000000 -i /home/data/Shared/AQPhan/norm_counts.csv -o /home/data/nlaszik/cuda_simulation/output/aqphan/ -mode no_np -ll -5.0 -ul 1.0

// SRP364225
// /home/data/nlaszik/cuda_simulation/code/cuda/build/create_and_fit_distributions_gillespie_mle -mi 100000 -mt 50.0 -mc 400 -s 1.0 -h 4.0 -bs 1000000 -i /home/data/Shared/shared_datasets/sc-rna-seq/SRP364225/seurat/SRR18335026_transcript_counts.filtered.norm.csv -o /home/data/nlaszik/cuda_simulation/output/SRP364225/SRR18335026_norm/ -mode no_np -ll -5.0 -ul 1.0
...
int main(int argc, char** argv)
{
	...
	double *real_distributions, *initial_distributions, *best_likelihoods;
	...
	for (int i_batch = 0; i_batch < num_batches; i_batch++){
		...
		simulate<<<numBlocks, blockSize>>>(max_iterations, max_time, num_cells, num_genes, i_batch, batch_size, i_param_combination, num_params, max_count, h, param_combinations, transcriptional_states, mrna_count, initial_distributions, real_distributions, best_likelihoods, best_params, best_counts, devStates);
