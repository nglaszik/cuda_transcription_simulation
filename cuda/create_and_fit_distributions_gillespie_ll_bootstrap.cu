...
__global__
void simulate(int max_iterations, double max_time, int num_cells, int num_genes, int num_bootstraps, int i_batch, int batch_size, int num_combinations_current_batch, const int num_params, int max_count, double h, double *param_combinations, int *transcriptional_states, int *mrna_count, double *simulated_distributions, int *bootstrap_mrna_count, double *best_mses, int *best_params, int *best_counts, curandState* globalState){
	...
	for (int i_param_combination = index; i_param_combination < num_combinations_current_batch; i_param_combination+=stride) {
		...
		//printf("sim %i 0 prob:%f\n", i_param_combination, simulated_distributions[0]);
		...
		for (int i_gene = 0; i_gene < num_genes; i_gene++) {
			...
			for (int i_bootstrap = 0; i_bootstrap < num_bootstraps; i_bootstrap++) {
				
				for (int i_cell = 0; i_cell < num_cells; i_cell++) {
					
					int i_bootstrap_gene_cell = i_bootstrap + num_bootstraps * i_gene + num_bootstraps * num_genes * i_cell;
					int real_count = bootstrap_mrna_count[i_bootstrap_gene_cell];
			...
			log_likelihood /= num_bootstraps;
			
			// regular log likelihood is MAXIMIZED for best estimator... neg. log. likelihood is minimized
			if (log_likelihood > best_mses[i_gene]){
				...
				//printf("new ll found: %f, %i\n", log_likelihood, i_gene);
			}
		}
	}
}
...
// nvcc /home/data/nlaszik/cuda_simulation/code/cuda/create_and_fit_distributions_gillespie_ll_bootstrap.cu -o /home/data/nlaszik/cuda_simulation/code/cuda/build/create_and_fit_distributions_gillespie_ll_bootstrap -lcurand -lboost_filesystem -lboost_system -lineinfo

// SRP215251
// /home/data/nlaszik/cuda_simulation/code/cuda/build/create_and_fit_distributions_gillespie_ll_bootstrap -mi 100000 -mt 50.0 -mc 400 -s 1.0 -h 4.0 -bs 2000000 -i /home/data/Shared/shared_datasets/sc_rna_seq/data/SRP215251/figures/wt/tpm_filtered.csv -o /home/data/nlaszik/cuda_simulation/output/SRP215251/WT -mode no_np -ll -5.0 -ul 1.0 -d -1.0

// /home/data/nlaszik/cuda_simulation/code/cuda/build/create_and_fit_distributions_gillespie_ll_bootstrap -mi 100000 -mt 50.0 -mc 400 -s 1.0 -h 4.0 -bs 2000000 -i /home/data/Shared/shared_datasets/sc_rna_seq/data/SRP215251/figures/dko/tpm_filtered.csv -o /home/data/nlaszik/cuda_simulation/output/SRP215251/DKO -mode no_np -ll -5.0 -ul 1.0 -d -1.0

// SRP313343
// /home/data/nlaszik/cuda_simulation/code/cuda/build/create_and_fit_distributions_gillespie_ll_bootstrap -mi 100000 -mt 50.0 -mc 400 -s 1.0 -h 4.0 -bs 2000000 -i /home/data/Shared/shared_datasets/sc_rna_seq/data/SRP313343/seurat/transcript_counts/srr14139729_transcript_counts.filtered.norm.csv -o /home/data/nlaszik/cuda_simulation/output/SRP313343/SRR14139729 -mode no_np -ll -5.0 -ul 1.0 -d -1.0

// SRP299892
// smaller batch size due to higher # of cells?
// /home/data/nlaszik/cuda_simulation/code/cuda/build/create_and_fit_distributions_gillespie_ll_bootstrap -mi 100000 -mt 10.0 -mc 400 -s 0.1 -h 2.0 -bs 1000000 -i /home/data/Shared/shared_datasets/sc_rna_seq/data/SRP299892/seurat/transcript_counts/srr13336770_transcript_counts.filtered.norm.csv -o /home/data/nlaszik/cuda_simulation/output/SRP299892_ll_bootstrap -mode no_np -ll -3.0 -ul 3.0 -d 0.0

// Test
// smaller batch size due to higher # of cells?
// /home/data/nlaszik/cuda_simulation/code/cuda/build/create_and_fit_distributions_gillespie_ll_bootstrap -mi 100000 -mt 10.0 -mc 400 -s 0.1 -h 2.0 -bs 1000000 -i /home/data/nlaszik/cuda_simulation/input/test_input.csv -o /home/data/nlaszik/cuda_simulation/output/test -mode no_np -ll -3.0 -ul 3.0 -d 0.0

// DKO
// /home/data/nlaszik/cuda_simulation/code/cuda/build/create_and_fit_distributions_gillespie_ll_bootstrap -mi 100000 -mt 10.0 -mc 150 -s 0.05 -h 1.0 -bs 1000000 -i /home/data/Shared/shared_datasets/sc_rna_seq/nlaszik/dko_atrinh_102022/seurat/transcript_counts/rep2_transcript_counts.filtered.norm.csv -o /home/data/nlaszik/cuda_simulation/output/dko_hesc/rep2_multirun_no_np -mode no_np -ll -3.0 -ul 3.0 -d -1.0

// DKO same median
// /home/data/nlaszik/cuda_simulation/code/cuda/build/create_and_fit_distributions_gillespie_ll_bootstrap -mi 100000 -mt 50.0 -mc 150 -s 1.0 -h 4.0 -bs 1000000 -i /home/data/Shared/shared_datasets/sc_rna_seq/data/dko_hesc/seurat/set_median/rep1_transcript_counts.filtered.norm.csv -o /home/data/nlaszik/cuda_simulation/output/dko_hesc/rep1_gillespie_set_median/ -mode no_np -ll -5.0 -ul 1.0 -d -1.0

// Andrew's data
// /home/data/nlaszik/cuda_simulation/code/cuda/build/create_and_fit_distributions_gillespie_ll_bootstrap -mi 100000 -mt 50.0 -mc 400 -s 1.0 -h 4.0 -bs 1000000 -i /home/data/Shared/AQPhan/norm_counts.csv -o /home/data/nlaszik/cuda_simulation/output/aqphan/ -mode no_np -ll -5.0 -ul 1.0 -d -1.0

// SRP364225
// /home/data/nlaszik/cuda_simulation/code/cuda/build/create_and_fit_distributions_gillespie_ll_bootstrap -mi 100000 -mt 50.0 -mc 400 -s 1.0 -h 4.0 -bs 1000000 -i /home/data/Shared/shared_datasets/sc_rna_seq/data/SRP364225/seurat/SRR18335026_transcript_counts.filtered.norm.csv -o /home/data/nlaszik/cuda_simulation/output/SRP364225/SRR18335026_norm/ -mode no_np -ll -5.0 -ul 1.0 -d -1.0
...
int main(int argc, char** argv)
{
	...
	int *best_counts, *best_params, *real_mrna_count, *bootstrap_mrna_count;
	...
	cudaMallocManaged(&bootstrap_mrna_count, num_bootstraps * num_genes * num_cells * sizeof(int));
	...
	for (int i_bootstrap = 0; i_bootstrap < num_bootstraps; i_bootstrap++){
		for (int i_gene = 0; i_gene < num_genes; i_gene++){
			for (int i_cell = 0; i_cell < num_cells; i_cell++){
				int i_bootstrap_gene_cell = i_bootstrap + num_bootstraps * i_gene + num_bootstraps * num_genes * i_cell;
				int i_cell_random = rand() % num_cells;
				int i_cell_gene_random = i_cell_random * num_genes + i_gene;
				bootstrap_mrna_count[i_bootstrap_gene_cell] = real_mrna_count[i_cell_gene_random];
			}
		}
	}
	
	printf("generating kdes...\n");
	...
	for (int i_batch = 0; i_batch < num_batches; i_batch++){
		...
		simulate<<<numBlocks, blockSize>>>(max_iterations, max_time, num_cells, num_genes, num_bootstraps, i_batch, batch_size, i_param_combination, num_params, max_count, h, param_combinations, transcriptional_states, mrna_count, simulated_distributions, bootstrap_mrna_count, best_mses, best_params, best_counts, devStates);
